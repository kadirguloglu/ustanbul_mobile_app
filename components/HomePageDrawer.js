...
import { StyleSheet, ViewPropTypes, Button, Image } from 'react-native';
...
class HomePageDrawer extends React.Component {
    ...
    componentWillMount() {
        this.ErrorProfilePicture = function () {
            this.setState({ profilePicturePath: require('../assets/profile-photo.jpg') });
        }
    }
    render() {
            ...
            <Container>
                <Content>
                    {activeUser.ProfilePicturePath ? (
                        <Image
                            source={this.state.profilePicturePath == '' ? { uri: MidPath(activeUser.ProfilePicturePath) } : this.state.profilePicturePath}
...
export default connect(mapStateToProps, mapDispatchToProps)(HomePageDrawer);