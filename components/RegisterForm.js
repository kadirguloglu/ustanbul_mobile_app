...
class RegisterForm extends Component {
    ...
    render() {
        console.log(this.state.RegisterFormType);
        ...
        if (this.state.RegisterFormType == "Facebook") {
            return <FacebookForm open_register_form={this.registerFormNull} login_form={this.props.form_change} />
        }
        if (this.state.RegisterFormType == "Twitter") {
            return <TwitterForm open_register_form={this.registerFormNull} login_form={this.props.form_change} />
        }
        if (this.state.RegisterFormType == "GooglePlus") {
            return <GooglePlusForm open_register_form={this.registerFormNull} login_form={this.props.form_change} />
        }
            ...
            return (<ImageBackground
                ...
                <Animatable.View animation="bounceInDown" style={[styles.loginScreenView]}>
                    ...
                    <Animatable.View animation="zoomIn" delay={1500}
                        onAnimationBegin={() => {
                            this.setState({ logoHeight: height * .2 })
                        ...
                        <View style={{ marginBottom: 10 }}>
                            <Button style={styles.button} title="Usta Arıyorum"
                                onPress={() => this.setState({ RegisterFormType: 'Customer' })} color="#d6471a" />
                        </View>
                        <View style={{ marginBottom: 10 }}>
                            <Button style={styles.button} title="Ustayım"
                                onPress={() => this.setState({ RegisterFormType: 'Master' })} color="#19c53b" />
                        </View>
                        <View style={{ marginBottom: 10 }}>
                            <Button style={styles.button} title="Şirketim"
                                onPress={() => this.setState({ RegisterFormType: 'Company' })} color={ThemeColor} />
                        </View>
                        ...
                        <View style={styles.socialLoginContainer}>
                            <FontAwesome
                                ...
                                name="google"
                                size={19}
                                onPress={() => this.setState({ RegisterFormType: 'GooglePlus' })} />
                            <FontAwesome
                                style={styles.socialLoginIcon}
                                name="facebook"
                                size={19}
                                onPress={() => this.setState({ RegisterFormType: 'Facebook' })} />
                            <FontAwesome
                                style={styles.socialLoginIcon}
                                name="twitter"
                                size={19}
                        ...
                        <TouchableHighlight onPress={() => this.props.form_change()} style={styles.registerTextContainer}>
